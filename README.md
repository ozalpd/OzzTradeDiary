...
- `TD.Validation` now includes a generated `QueryParameters` class for reusable pagination/search query inputs
...
- `QueryParameters` class generation is enabled for shared pagination/search contracts in `TD.Validation`
