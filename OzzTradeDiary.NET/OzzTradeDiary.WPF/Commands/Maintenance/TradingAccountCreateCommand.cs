...
namespace TD.WPF.Commands.Maintenance
{
    internal partial class TradingAccountCreateCommand : AbstractCommand
    {
        ...
        /// <summary>
        /// Before executing the command, we can set this property to have the exchange preselected in the TradingAccount creation dialog.
        /// This is useful when you want to create a TradingAccount for a specific exchange and want to save the user from having to select it manually.
        /// </summary>
