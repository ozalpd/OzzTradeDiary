...
namespace TD.WPF.Commands.Maintenance
{
    internal partial class SymbolCreateCommand : AbstractCommand
    {
        ...
        /// <summary>
        /// Before executing the command, we can set this property to have the exchange preselected in the Symbol creation dialog.
        /// This is useful when you want to create a Symbol for a specific exchange and want to save the user from having to select it manually.
        /// </summary>
