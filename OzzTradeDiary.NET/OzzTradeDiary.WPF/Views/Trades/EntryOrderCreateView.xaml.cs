...
{
    // Codebehind for EntryOrderCreateView.xaml
    public partial class EntryOrderCreateView : Window
    {
        private readonly EntryOrderCreateVM _viewModel;
        ...
        public EntryOrderCreateView() : this(null)
        {
        ...
        public EntryOrderCreateView(Trade? preselectedTrade)
        {
            InitializeComponent();

            _viewModel = new EntryOrderCreateVM();
            DataContext = _viewModel;
            _preselectedTrade = preselectedTrade;
            SourceInitialized += EntryOrderCreateView_SourceInitialized;
        }

        private async void EntryOrderCreateView_SourceInitialized(object? sender, EventArgs e)
        {
