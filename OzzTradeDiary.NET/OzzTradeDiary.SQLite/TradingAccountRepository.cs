...
namespace TD.SQLite
{
    ...
    {
        public TradingAccountRepository(string databasePath, IExchangeRepository? exchangeRepository = null) : base(databasePath, "TradingAccounts")
        ...
        /// </summary>
        partial void OnInitialized(bool isExchangeRepository);
