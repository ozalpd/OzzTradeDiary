...
namespace TD.Data
{
    ...
    public partial class EntryOrder : IId, IDisplayOrder
    {
        ...
        // Use below function in a partial class file (eg. EntryOrder.part.cs)
        // to add more complexity to clone
        partial void Cloning(EntryOrder clone);
    }
    
    //Data Transfer Object type for EntryOrder
    public partial class EntryOrderDTO : IId, IDisplayOrder
    {
        public EntryOrderDTO() { }
    
        public EntryOrderDTO(EntryOrder entity)
        {
            Id = entity.Id;
        ...
        partial void Initilazing(EntryOrder entity);
        
        public virtual EntryOrder ToEntryOrder()
        {
            var entity = new EntryOrder();
            entity.Id = Id;
        ...
        partial void Converting(EntryOrder entity);
