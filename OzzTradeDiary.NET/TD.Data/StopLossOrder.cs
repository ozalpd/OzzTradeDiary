...
namespace TD.Data
{
    ...
    public partial class StopLossOrder : IId, IDisplayOrder
    {
        ...
        // Use below function in a partial class file (eg. StopLossOrder.part.cs)
        // to add more complexity to clone
        partial void Cloning(StopLossOrder clone);
    }
    
    //Data Transfer Object type for StopLossOrder
    public partial class StopLossOrderDTO : IId, IDisplayOrder
    {
        public StopLossOrderDTO() { }
    
        public StopLossOrderDTO(StopLossOrder entity)
        {
            Id = entity.Id;
            TradeId = entity.TradeId;
            StopAll = entity.StopAll;
        ...
        partial void Initilazing(StopLossOrder entity);
        
        public virtual StopLossOrder ToStopLossOrder()
        {
            var entity = new StopLossOrder();
            entity.Id = Id;
            entity.TradeId = TradeId;
            entity.StopAll = StopAll;
        ...
        partial void Converting(StopLossOrder entity);
